...
function! zen_coding#Zen_expandAbbr(mode) range
...
function! zen_coding#Zen_moveNextPrev(flag)
...
function! zen_coding#Zen_imageSize()
...
function! zen_coding#Zen_toggleComment()
...
function! zen_coding#Zen_balanceTag(flag) range
...
function! zen_coding#ZenCompleteTag(findstart, base)
  if a:findstart
    let line = getline('.')
    let start = col('.') - 1
